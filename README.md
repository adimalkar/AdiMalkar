...
| **[sqlfluff](https://github.com/sqlfluff/sqlfluff)** | <a href="https://github.com/sqlfluff/sqlfluff"><img src="https://img.shields.io/github/stars/sqlfluff/sqlfluff?style=flat-square&label=%E2%98%85" alt="Stars"/></a> | [#8411](https://github.com/sqlfluff/sqlfluff/pull/8411) (merged) | Fixed reflow alignment pads when an alignment predecessor sat on a different line (leading-comma T-SQL). |
